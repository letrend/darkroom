...
xst -ifn xst.scr
move clk16MHz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk16MHz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk16MHz_exdes.ucf clk16MHz_exdes

echo 'Running map'
map -timing -pr b clk16MHz_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clk16MHz_exdes -w routed.ncd routed.vhd
cd ..
